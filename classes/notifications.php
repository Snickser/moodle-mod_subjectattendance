...
/** Notifications for mod_subjectattendance.
 *
 * @package    mod_subjectattendance
 * @copyright  2025 Alex Orlov <snickser@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace mod_subjectattendance;
...
class notifications {
    ...
    public static function notify($userid, $cmid, $status = null) {
        ...
        $message->component = 'mod_subjectattendance';
        $message->name      = 'subjectattendance_receipt'; // The notification name from message.php.
        $message->userfrom  = \core_user::get_noreply_user(); // If the message is 'from' a specific user you can set them here.
        $message->userto    = $user;
        $message->subject   = get_string('messagesubject', 'mod_subjectattendance');

        $messagebody = get_string('messagebody', 'mod_subjectattendance', $a);
