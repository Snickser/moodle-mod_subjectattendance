...
class backup_subjectattendance_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_subjectattendance_activity_structure_step('subjectattendance_structure', 'subjectattendance.xml'));
    }
    ...
    public static function encode_content_links($content) {
        ...
        $content = preg_replace("/(" . $base . "\/mod\/subjectattendance\/view.php\?id=)([0-9]+)/", '$@SUBJECTATTENDANCEVIEWBYID*$2@$', $content);
