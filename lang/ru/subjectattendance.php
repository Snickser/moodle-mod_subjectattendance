...
$string['subjectslist_desc'] = '⚠️ В строке через раздeлитель "|" можно указать числовой вес для обратной сортировки предметов на странице просмотра, например: "имя|10".';
$string['subjectslist_help'] = 'Новые предметы добавляются в конец списка. Изменение имени ранее добавленных не производится, будет удаление старого и добавление нового, потому заранее следите за наименованием. Через разделитель "|" можно указать числовой вес для сортировки, и вес можно менять.';
